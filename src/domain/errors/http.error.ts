...
export class HttpError extends BaseError<HttpErrorJson> {
     ...
     * @return {HttpError} An instance of HttpClientError with a status code of 400.
     */
     ...
     * @return {HttpError} An instance of HttpClientError with a status code of 404.
     */
     ...
     *
     * @param {string} [message] The error message. If not provided, a default message is used.
     * @return {HttpError} An instance of HttpClientError with a status code of 500.
     */
